...
namespace Borodar.RainbowFolders
{
    ...
    public static class ProjectEditorUtility
    {
        ...
        public static bool SearchField(ref string query, ref Enum filter, Enum defaultFilter, params GUILayoutOption[] options)
        {
            ...
            var queryRect = GUILayoutUtility.GetRect(GUIContent.none, "ToolbarSeachTextFieldPopup", options);
            queryRect.x += 2f;
            queryRect.width -= 13f;
            ...
            query = EditorGUI.TextField(queryRect, GUIContent.none, query, "ToolbarSeachTextFieldPopup");
            ...
            if (GUI.Button(cancelRect, GUIContent.none, "ToolbarSeachCancelButton"))
            {
                query = string.Empty;
